  ...
  **Features:**  
  ...
  - **Form Factor:** Rack-mountable (1U)  
    ...
    "specifications": [
      {
        "key": "Product Type",
        "value": "Layer 3 Managed Switch"
      },
      {
        "key": "MAC Address Table Size",
        "value": "12K entries"
      },
      {
        "key": "Jumbo Frame Support",
        "value": "9016 bytes"
      },
      {
        "key": "Performance",
      ...
      },
      {
        ...
        "value": "24 x 10/100 Ethernet (RJ-45), 2 x SFP (mini-GBIC), 1 x Console (RJ-45)"
      },
      {
        "key": "Power Supply",
        "value": "Internal (AC 120/230V, 50/60Hz)"
      },
      {
      ...
      },
      {
        ...
        "value": "IEEE 802.3, 802.3u, 802.3z, 802.3ab, 802.1D, 802.1Q, 802.1p, 802.1x, 802.1s, 802.1w, 802.3x, 802.3ad (LACP)"
      },
      {
      ...
      {
        "key": "Dimensions",
        "value": "44.3 cm x 29.5 cm x 4.4 cm"
      },
      {
        "key": "Weight",
        "value": "3.7 kg"
      ...
      },
      {
        ...
        "value": "CE, GOST, CISPR 24, NOM, EN55024, EN55022 Class A, CISPR 22, EMC, UL 60950-1, IEC 60950-1, EN 60950-1, FCC Part 15 A"
      }
    ],
    "isFeatured": false
  },  
  ...
  **Features:**  
  ...
  - **Built-in QoS & Traffic Handling:**  
    ...
    "specifications": [
      ...
      {
        "key": "RAM & Flash Memory",
        "value": "128MB RAM / 128MB Flash"
      },
      {
      ...
      {
        "key": "Design",
        "value": "Fanless, Rack-Mountable"
      },
      {
        "key": "QoS & Traffic Control",
        "value": "Integrated QoS prioritization for voice/video, loop detection, and cable diagnostics"
      },
      {
        "key": "Compliance Standards",
      ...
      {
        "key": "Dimensions",
        "value": "279.4 mm x 170 mm x 44 mm"
      },
      {
        "key": "Weight",
        "value": "1.5 kg"
  ...
  **Weight**  
  4.15 lbs (1.88kg)`,
    ...
    "specifications": [
      ...
      {
        "key": "Dimensions",
        "value": "279.40 mm x 44.45 mm x 170.18 mm"
      },
      {
        "key": "Weight",
        "value": "1.88 kg"
  ...
  **Installation:**  
  ...
  Catalyst 2960 Series Intelligent Ethernet Switches are a new family of fixed-configuration standalone devices that provide desktop Fast Ethernet and Gigabit Ethernet connectivity, enabling enhanced LAN services for entry-level enterprise, mid-market, and branch office networks. The Catalyst 2960 Series offers integrated security, including network admission control (NAC), advanced quality of service (QoS), and resiliency to deliver intelligent services for the network edge.
    ...
    "specifications": [
      {
        "key": "Device Type",
        "value": "Switch - 24 ports - Managed"
      },
      {
        "key": "Enclosure Type",
        "value": "Rack-mountable - 1U"
      },
      {
        "key": "Ports",
        "value": "24 x 10/100 + 2 x combo Gigabit SFP"
      },
      {
        "key": "Performance",
        "value": "Switching capacity: 32 Gbps, Forwarding performance (64-byte packet size): 6.5 Mpps"
      },
      {
        "key": "MAC Address Table Size",
        "value": "8K entries"
      },
      {
        ...
        "value": "SNMP 1, SNMP 2, RMON 1, RMON 2, RMON 3, RMON 9, Telnet, SNMP 3, SNMP 2c, HTTP, HTTPS, TFTP, SSH"
      },
      {
        "key": "Compliant Standards",
        "value": "IEEE 802.3, IEEE 802.3u, IEEE 802.3z, IEEE 802.1D, IEEE 802.1Q, IEEE 802.3ab, IEEE 802.1p, IEEE 802.3x, IEEE 802.3ad (LACP), IEEE 802.1w, IEEE 802.1x, IEEE 802.1s, IEEE 802.3ah, IEEE 802.1ab (LLDP)"
      },
      {
        "key": "Power",
  ...
  },
  {
    ...
    "categories": ["Networking", "Wired Networking", "Switches", "Cisco"],
    "currency": "NGN",
    "description": "Cisco Catalyst 2960 Intelligent Ethernet Switches enable entry-level enterprise, medium-sized, and branch office networks to provide enhanced LAN services. This family of fixed-configuration, standalone devices provide desktop 10/100 Fast Ethernet and 10/100/1000 Gigabit Ethernet connectivity.",
    "warranty": "Limited lifetime warranty",
    "reviews": [],
    "price": 1228672.63,
    "discountPercentage": 0,
    ...
    "specifications": [
      ...
      {
        "key": "Performance",
        "value": "Switching capacity : 16 Gbps | Forwarding performance (64-byte packet size) : 6.5 Mpps"
      },
      {
        "key": "MAC Address Table Size",
        "value": "8K entries"
      ...
      {
        "key": "Remote Management Protocol",
        "value": "SNMP 1, SNMP 2, RMON 1, RMON 2, Telnet, SNMP 3, SNMP 2c, HTTP, HTTPS, TFTP, SSH-2"
      },
      {
        "key": "Features",
        "value": "Layer 2 switching, auto-sensing per device, DHCP support, auto-negotiation, VLAN support, auto-uplink (auto MDI/MDI-X), IGMP snooping, Syslog support, DiffServ support, Broadcast Storm Control, Multicast Storm Control, Unicast Storm Control, Rapid Spanning Tree Protocol (RSTP) support, Multiple Spanning Tree Protocol (MSTP) support, Dynamic Trunking Protocol (DTP) support, Port Aggregation Protocol (PAgP) support, Quality of Service (QoS), Link Aggregation Control Protocol (LACP), Port Security, MAC Address Notification"
      },
      {
        "key": "Compliant Standards",
        "value": "IEEE 802.3, IEEE 802.3u, IEEE 802.3z, IEEE 802.1D, IEEE 802.1Q, IEEE 802.3ab, IEEE 802.1p, IEEE 802.3x, IEEE 802.3ad (LACP), IEEE 802.1w, IEEE 802.1x, IEEE 802.1s, IEEE 802.3ah, IEEE 802.1ab (LLDP)"
  ...
  },
  {
    ...
    "warranty": "Enhanced limited lifetime hardware warranty (E-LLW), providing next-business-day replacement",
    "reviews": [],
    "price": 1154024.64,
    ...
    "specifications": [
      ...
      {
        "key": "Power",
        "value": "370W Power over Ethernet (PoE)"
      },
      {
        "key": "IOS Software",
        "value": "LAN Base"
      ...
      },
      {
        ...
        "value": "Four egress queues per port, Strict priority queuing, Shaped Round Robin (SRR), Weighted Tail Drop (WTD)"
      },
      {
